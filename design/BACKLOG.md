...
| **F20-6** | **BUG: ny plats sparas inte** (bröllop 8/8). PlatsArk "Nöbbelöv kyrka" m upphämtad koord, men jobbet visar ändå "Okänd arena — Lund, Sverige". "Vyn ser knepig ut" = **sannolikt delvis "sporttänket": fältet heter "ARENA" och texten säger "arenan" — men en kyrka är ingen arena** (Stig 20/7) | bug + terminologi | **REMOTE-VERIFIERBART:** (a) PlatsArk→`ArenaOverride`-persistensen (J-3/J-4/J-5) — trolig rot: override-nyckeln matchar inte jobbet vid inläsning · (b) **de-sportifiera etiketterna för icke-sportjobb** (Arena→Plats, "Var" i stället för "Okänd arena") — kategoristyrt, samma familj som SPORT-ORD. HÖG — trasig levererad funktion. Se [[feedback-sporttank-lacker-till-icke-sport]] |
