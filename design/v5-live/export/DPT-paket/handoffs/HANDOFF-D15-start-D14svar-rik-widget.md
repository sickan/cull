...
- **HÄR (vänster):** rubrik `HÄR · IDAG`, väder **08–20 i 5 segment** (tid + mono linjeikon + temp), underrad **`Borlänge`** (bara orten — vädertjänsten bor i Inställningar, se D21-SVAR §0).
