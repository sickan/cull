...
- **HÄR (vänster):** rubrik `HÄR · IDAG`, väder **08–20 i 5 segment** (tid + mono ikon + temp), underrad **`Borlänge`** (bara orten; vädertjänsten flyttad till Inställningar — D21-SVAR §0).
