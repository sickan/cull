...
- **HÄR (vänster):** rubrik `HÄR · IDAG`, väder **08–20 i 5 segment** (tid + mono linjeikon + temp), underrad **`Borlänge`** (bara orten — vädertjänsten bor i Inställningar, se D21-SVAR §0).ller manuell); "Ledig" när du är det.
...
- **Nedräkning/avgång** bärs av **inline-raden ovanför klockan** (`Friidrotts-SM 14:00 · åk 12:15`) — inte av en gauge-cirkel. *(RÄTTAT D21: ingen "Tjänst" — det var vädertjänst, inte pass.)*
