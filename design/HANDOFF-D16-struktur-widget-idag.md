...
- **HÄR (vänster):** rubrik `HÄR · IDAG`, väder **08–20 i 5 segment** (tid + mono ikon + temp), underrad `Borlänge · Tjänst 2431` (din dagliga tjänst ur kalender/manuell; "Ledig" när du är det).
...
- Panelerna är **topp-alignade**. Avgång/nedräkning bärs av **inline-raden ovanför klockan** (t.ex. "Tjänst 2431 · Friidrotts-SM 14:00 · åk 12:15").
